    ...
    if (y <= distance_y * 2 - 10 && y >= 2 * obstacle_height + 50) {
        for (let i = 0; i < obstacles_arr3.length; i++) {
            if (obstacles_arr3[i] == "true") {
                if ((x + radius >= obstacle_x + distance_y * i && x + radius <= obstacle_x + distance_y * i + obstacle_width) || (x - radius >= obstacle_x + distance_y * i && x - radius <= obstacle_x + distance_y * i + obstacle_width)) {
                    y_speed = -y_speed
